...
const projects = [
    {
        title: 'Haptic Vision: Accessible Robotic Technology for the Blind and Low Vision',
    ...
    },
    {
        ...
        description:
            "Wealthseed is developing an interactive, asynchronous course and platform to transform financial literacy education for secondary school students. The project for this cohort is to develop a \"mini\" simulator focused on budgeting. The simulator, inspired by games like Bitlife, will expose players to realistic decision-making situations that impact their character's wealth, health, and happiness. The simulation is broken down into three main life stages: high school, university, and career/adulthood. Students will learn core concepts such as understanding wants vs. needs, managing debt, and long-term financial planning. The final deliverable is a budgeting simulator that visualizes a user's \"financial life journey\" based on their choices.",
        status: 'current',
        img: '/projects/Wealthseed.jpg',
    },
    {
