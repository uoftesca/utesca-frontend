...
export default function EventCard({
    ...
    const hasValidImage =
        Boolean(image) && !image?.includes("example.com");
    ...
    return (
        <div className="relative w-full">
            <div
                className={`flex items-start gap-8 transition-transform duration-300 ease-in-out ${showRegistration
                    ? "-translate-x-[216px]"
                    : ""
                    }`}
            >
                                ...
                                <div className="flex items-start justify-between w-full">
                                    <div className="flex items-start gap-3">
                                        <CollapsibleTrigger asChild>
                                            ...
                                            >
                                                <Triangle
                                                    className={`transition-transform duration-200 fill-current ${isOpen
                                                        ? "rotate-180"
                                                        : "rotate-90"
                                                        }`}
                                                />
                                        ...
                                        <h3 className="font-normal text-left">
                                            {title}
                                        </h3>
                                    </div>
